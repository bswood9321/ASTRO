...
print('b={0:.3f}+/-{1:.3f}'.format(w[0],np.sqrt(cov[1,1])))
...
initial = np.array([m_true,b_true,np.log(f_true)])+0.1*rand.randn(3)
...
pos = soln.x + 1e-4 * rand.randn(32, 3)
nwalkers, ndim = pos.shape

sampler = mc.EnsembleSampler(nwalkers, ndim, log_probability, args=(x, y, yerr))
